    ...
    <div className="min-h-screen bg-parchment flex flex-col">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-ink-200">
        <div className="h-14 flex items-center gap-2 sm:gap-3 px-3 sm:px-6">
          ...
          {/* Chapter cover banner — Wattpad style full width */}
            <div className="w-full bg-gray-100 relative flex items-center justify-center"
              ...
              {chapterCoverPreview ? (
                <>
                  ...
                  <div className="absolute bottom-3 right-3 z-10">
                    <div className="relative">
                      <button
                        onClick={() => document.getElementById('chapter-cover-options').classList.toggle('hidden')}
                        className="w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-ink-50 transition-colors"
                      >
                        <svg className="w-4 h-4 text-ink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
                      </button>
                      <div id="chapter-cover-options" className="hidden absolute bottom-12 right-0 bg-white border border-ink-200 rounded-xl shadow-xl overflow-hidden w-44">
                        <label className="flex items-center gap-2 px-4 py-2.5 text-sm text-midnight hover:bg-ink-50 cursor-pointer transition-colors">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                          Replace image
                        ...
                        <button
                          onClick={() => {
                            handleRemoveChapterCover()
                            document.getElementById('chapter-cover-options').classList.add('hidden')
                          }}
                ...
                /* Empty state — two buttons parang Wattpad */
                <div className="flex items-center gap-4">
                  <label className="flex flex-col items-center gap-2 bg-white border border-ink-200 rounded-xl px-8 py-5 cursor-pointer hover:border-ink-400 hover:bg-ink-50 transition-all group">
                    <svg className="w-8 h-8 text-ink-400 group-hover:text-ink-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span className="text-xs font-medium text-ink-500 group-hover:text-ink-700">Add image</span>
                    <input type="file" accept="image/*" className="hidden" onChange={handleChapterCoverUpload} />
                  </label>
                </div>
              )}
